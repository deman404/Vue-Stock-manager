      ...
      >
        <div class="flex items-start justify-between mb-4">
          ...
          <span 
            ...
            :class="client.company ? 'bg-blue-100 text-blue-800 dark:bg-blue-900/20 dark:text-blue-400' : 'bg-gray-100 text-gray-800 dark:bg-gray-900/20 dark:text-gray-400'"
          >
        ...
        <div class="space-y-2 mb-4">
          <div class="flex items-center space-x-2">
            ...
            <span class="text-sm text-gray-600 dark:text-gray-300">{{ client.email }}</span>
          </div>
          <div v-if="client.phone" class="flex items-center space-x-2">
            <PhoneIcon class="w-4 h-4 text-gray-400" />
            <span class="text-sm text-gray-600 dark:text-gray-300">{{ client.phone }}</span>
          </div>
          <div v-if="client.address" class="flex items-start space-x-2">
            <MapPinIcon class="w-4 h-4 text-gray-400 mt-0.5" />
            <span class="text-sm text-gray-600 dark:text-gray-300">{{ client.address }}</span>
          </div>
        </div>
...
const filteredClients = computed(() => {
  let filtered = [...ordersStore.clients]
