      ...
      <div class="card p-6">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-2xl font-bold text-error-600 dark:text-error-400 mt-2">
      ...
      <div class="card p-6">
        ...
        <div class="space-y-4 max-h-96 overflow-y-auto">
          <div 
            ...
            :class="product.stock === 0 ? 'bg-error-50 dark:bg-error-900/20' : 'bg-warning-50 dark:bg-warning-900/20'"
          >
            <img 
            ...
            <div class="flex-shrink-0">
              <span 
                ...
                :class="product.stock === 0 ? 'bg-error-100 text-error-800 dark:bg-error-900/20 dark:text-error-400' : 'bg-warning-100 text-warning-800 dark:bg-warning-900/20 dark:text-warning-400'"
              >
          ...
          >
            <div class="flex-shrink-0">
              ...
              >
                ...
                <ArrowDownIcon v-else-if="movement.type === 'out'" class="w-5 h-5" />
            ...
            <div class="text-right">
              <p 
                ...
                :class="movement.type === 'in' ? 'text-success-600' : movement.type === 'out' ? 'text-error-600' : 'text-primary-600'"
              >
...
const totalStockValue = computed(() => 
  productsStore.products.reduce((total, product) => 
